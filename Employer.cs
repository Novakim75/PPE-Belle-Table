    ...
    public class Employer
    {
        ...
        public bool SupprimerEmploye()
        {
            try
            {
                ...
                dbCon.UserName = "root";
                dbCon.Password = Crypto.Decrypt("r7bmN7pqFWFZMyztVQ8FCA==");//Pour éviter d'afficher le mot de passe en clair dans le code
                if (dbCon.IsConnect())
                {
        ...
        private void AjoutEmploye()
        {
            try
            {
                Id = AppelerProcedureStockeeEmploye();
                DBConnection dbCon = new DBConnection();
                dbCon.Server = "ppebelletablecerfal.chaisgxhr4z6.eu-west-3.rds.amazonaws.com";
                dbCon.DatabaseName = "PPE_THIBAULT";
                dbCon.UserName = "admin";
        ...
        private int AppelerProcedureStockeeEmploye()
        {
            try
            {
                DBConnection dbCon = new DBConnection();
